...
export declare class SQLParser extends Parser {
    ...
    static readonly PARAM_MARK = 9;
    static readonly WS = 10;
    static readonly TRANSFORM_ARROW = 11;
    static readonly SPREAD = 12;
    static readonly NAME_TAG = 13;
    static readonly TYPE_TAG = 14;
    static readonly OB = 15;
    static readonly CB = 16;
    static readonly COMMA = 17;
    static readonly C_REQUIRED_MARK = 18;
    static readonly ANY = 19;
    static readonly CLOSE_COMMENT = 20;
