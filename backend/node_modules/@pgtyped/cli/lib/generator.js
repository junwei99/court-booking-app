...
import { processSQLQueryIR, processTSQueryAST, ParameterTransform, } from '@pgtyped/runtime';
...
export function generateDeclarationFile(contents, fileName, connection, mode, config) {
    return __awaiter(this, void 0, void 0, function* () {
