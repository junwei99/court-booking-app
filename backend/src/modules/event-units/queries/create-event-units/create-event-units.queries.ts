...
const insertEventUnitsIR: any = {"usedParamSet":{"eventUnitList":true},"params":[{"name":"eventUnitList","required":false,"transform":{"type":"pick_array_spread","keys":[{"name":"name","required":false},{"name":"price","required":false},{"name":"venueId","required":false},{"name":"eventCategoryId","required":false}]},"locs":[{"a":74,"b":87}]}],"statement":"INSERT INTO event_units (name, price, venue_id, event_category_id) VALUES :eventUnitList RETURNING id"};
